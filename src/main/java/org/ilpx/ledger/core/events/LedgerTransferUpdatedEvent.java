...
/**
 * An event that is sent by a ledger when a transferFunds has been updated.
 */
@Getter
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
public class LedgerTransferUpdatedEvent extends LedgerTransferEvent {
    ...
    public LedgerTransferUpdatedEvent(
