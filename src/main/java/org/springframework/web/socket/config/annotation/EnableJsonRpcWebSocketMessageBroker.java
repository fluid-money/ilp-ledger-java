...
import org.springframework.web.socket.config.annotation.DelegatingJsonRpcWebSocketMessageBrokerConfiguration;
...
@Documented
@Import(DelegatingJsonRpcWebSocketMessageBrokerConfiguration.class)
public @interface EnableJsonRpcWebSocketMessageBroker {
