 ...
 * @since 4.0
 */
public interface JsonRpcWebSocketEndpointRegistration {

    /**
     * Configure the HandshakeHandler to use.
     */
    JsonRpcWebSocketEndpointRegistration setHandshakeHandler(HandshakeHandler handshakeHandler);

    /**
     * Configure the HandshakeInterceptor's to use.
     */
    JsonRpcWebSocketEndpointRegistration addInterceptors(HandshakeInterceptor... interceptors);
     ...
     * @see <a href="https://github.com/sockjs/sockjs-client#supported-transports-by-browser-html-served-from-http-or-https">SockJS
     * supported transports by browser</a>
     * @since 4.1.2
     */
    JsonRpcWebSocketEndpointRegistration setAllowedOrigins(String... origins);
