...
public class LedgerTransferEventListener implements LedgerEventListener {

    // TODO: Combine this and the other listeners into an abstract super class.
    ...
    /**
     * The {@link LedgerTransferId} for which this listener is listening to events for.
     */
    @NonNull
     ...
     */
    public LedgerTransferEventListener(
            final LedgerInfo ledgerInfo, final String subscriberId, final LedgerTransferId ledgerTransferId
    ) {
